...
namespace Servicios.Usuario
{
    public class UsuarioServicio : IUsuarioServicio
    {
        ...
        public Dominio.Entidades.Usuario Crear(long empleadoId, string apellidoEmpleado, string nombreEmpleado)
        {
        ...
        public DtoBase Obtener(long id)
        {
            ...
            var usuarioObtenido = new UsuarioDto
            {
        ...
        {
            Expression<Func<Dominio.Entidades.Empleado, bool>> filtro = usuario =>
            usuario.Apellido.Contains(cadenaBuscar)
           || usuario.Nombre.Contains(cadenaBuscar)
           || usuario.Dni == cadenaBuscar;

            if (!mostrarTodos) filtro = filtro.And(x => !x.EstaEliminado);
